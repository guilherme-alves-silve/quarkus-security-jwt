package br.com.guilhermealvessilve.security.jwt.utils;
...
public class TokenUtils {
    ...
    public static String generateTokenString(
            final String jsonResName,
            final Map<String, Long> timeClaims
    ) throws Exception {
    ...
    public static String generateTokenString(final JwtClaims jwtClaims) throws Exception {

        PrivateKey privateKey = readPrivateKey("/privateKey.pem");
        JwtClaimsBuilder claims = Jwt.claims(jwtClaims.getClaimsMap());
        long currentTimeInSecs = currentTimeInSecs();
        ...
        return claims.jws().signatureKeyId("/privateKey.pem").sign(privateKey);
    }
